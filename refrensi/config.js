...
const config = {
  ...
  owner: {
    name: "𝑨𝒏𝒊𝒕𝒂 𝑷𝒖𝒕𝒓𝒊 𝑨𝒛𝒛𝒂𝒉𝒓𝒂", // Nama owner
    number: ["6282191035625"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "6282191709610", // Nomor WA yang akan di-pair, ini penting
  ...
  bot: {
    ...
    version: "4.4", // Versi bot
    developer: "𝑨𝒏𝒊𝒕𝒂 𝑷𝒖𝒕𝒓𝒊 𝑨𝒛𝒛𝒂𝒉𝒓𝒂", // Nama developer
  },
  ...
  payment: {
    qrisUrl: "",
    methods: [
      { name: "Dana", number: "082191709610", holder: "𝑨𝒏𝒊𝒕𝒂 𝑷𝒖𝒕𝒓𝒊 𝑨𝒛𝒛𝒂𝒉𝒓𝒂" }, //ganti aja terserah kamu
      { name: "GoPay", number: "082191709610", holder: "𝑨𝒏𝒊𝒕𝒂 𝑷𝒖𝒕𝒓𝒊 𝑨𝒛𝒛𝒂𝒉𝒓𝒂" },  //ganti aja terserah kamu
      { name: "OVO", number: "082191709610", holder: "𝑨𝒏𝒊𝒕𝒂 𝑷𝒖𝒕𝒓𝒊 𝑨𝒛𝒛𝒂𝒉𝒓𝒂" },  //ganti aja terserah kamu
    ],
    banks: [],
  ...
  sticker: {
    packname: "Rimuru-MD", // Nama pack sticker
    author: "𝑨𝒏𝒊𝒕𝒂 𝑷𝒖𝒕𝒓𝒊 𝑨𝒛𝒛𝒂𝒉𝒓𝒂", // Author sticker
  },

  saluran: {
    id: "120363412350560864@newsletter",
    name: "Saluran Resmi Rimuru-MD",
    link: "https://whatsapp.com/channel/0029Vb8dmsUElagkVPIw9X2P",
  },
  ...
  geminiApiKey: "", // isi APIkey Gemini
